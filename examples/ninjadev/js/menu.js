...
var menuState = {
	create: function(){
		...
		this.NinjaDev = this.game.add.image(this.game.world.centerX, 0, 'ninjadev');
		this.NinjaDev.anchor.x = 0.5;
		...
		this.game.input.keyboard.addKey(Phaser.Keyboard.K).onDown.add(this.killNinja, this);
		...
		this.dragon = this.game.add.rope(this.game.world.centerX - (dragonCache.width /2),this.game.world.centerY + 50,'dragon', null, points);
		this.dragon.pivot.set(0.5);
		this.dragon.scale.set(1);
